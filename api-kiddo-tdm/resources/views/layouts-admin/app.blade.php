...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{route('students')}}" class="nav-link">Alunos</a>
      </li>

      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{route('responsibles')}}" class="nav-link">Alunos</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{route('contracts')}}" class="nav-link">Contratos</a>
      </li>
    </ul>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Kiddo - TDM</span>
    </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          {{-- <li class="nav-item menu-close">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('class-room.index')}}" class="nav-link ">
                  <i class="fa fa-eye nav-icon"></i>
                  <p>Listar Turmas</p>
                </a>
              </li>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('class-room.create')}}" class="nav-link ">
